...
|----------|-------------|
| [Architecture](./architecture) | System architecture, key principles, and data flow |
| [aai.json Descriptor](./aai-json) | Descriptor format, structure, and field reference |
| [Security Model](./security) | Two-layer authorization: Gateway Consent + App Authorization |
| [Error Codes](./error-codes) | Standardized error codes and HTTP status mapping |
| [Discovery](./discovery) | On-demand loading via MCP resources |

## Platform Guides

| Platform | Description |
|----------|-------------|
| [macOS](./platforms/macos) | JSON over Apple Events IPC |
| [Web](./platforms/web) | JSON over HTTP with OAuth 2.1 |
